...
# Update file location for other users' local machine:
d <- read.csv("C:/Users/jaure/Downloads/GlobalLandTemperatures_GlobalLandTemperatures_California.csv", stringsAsFactors=TRUE)
```
